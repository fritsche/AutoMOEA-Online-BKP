...
public class FixedHighLevelHeuristic<T> implements HighLevelHeuristic<T> {
	
	private List<T> lowlevelheuristcs;

	public FixedHighLevelHeuristic() {
	...
	public T get() {
		if (lowlevelheuristcs.size() > 0) { 
			return lowlevelheuristcs.get(0);
		}
		return null;
	}
